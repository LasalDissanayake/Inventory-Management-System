...
const NavBar = () => {
  ...
  return (
    <nav style={{ backgroundColor: "#001F3F" }} className="text-white px-8 py-4 flex justify-between items-center fixed min-w-full">
      <div className="flex items-center">
        <h1 className="text-xl font-bold">Blue Aqua Pets</h1>
      </div>
